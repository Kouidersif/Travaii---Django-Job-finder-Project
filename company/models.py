...
class CompanyProfile(models.Model):
    ...
    city= models.ForeignKey(Cities, related_name='company_city', on_delete=models.SET_NULL, null=True)
    state= models.ForeignKey(Wilaya, related_name='company_wilaya', on_delete=models.SET_NULL, null=True)
