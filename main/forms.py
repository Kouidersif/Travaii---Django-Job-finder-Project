...
class ContactForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['full_name'].widget.attrs['placeholder'] = 'Jhon Doe'
        self.fields['title'].widget.attrs['class'] = 'form-control'
        self.fields['title'].widget.attrs['placeholder'] = 'Reason'
        self.fields['message'].widget.attrs['class'] = 'form-control'
        self.fields['message'].widget.attrs['placeholder'] = 'Message Content'
