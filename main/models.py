...
class Jobs(models.Model):
    ...
    job_category = models.ForeignKey('Category', related_name='job_categories' ,on_delete=models.SET_NULL, null=True)
...
class Applying(models.Model):
    ...
    experience= models.CharField(max_length=5, choices=exper)
